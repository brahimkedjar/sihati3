class Patients::RegistrationsController < Devise::RegistrationsController
  ...
  def create
   ...
   if @patient.save
     ...
     respond_to do |format|
       format.html { redirect_to new_patient_registration_path, notice: "You have successfully signed up. Please sign in to continue." }
  ...
  def configure_account_update_params
    devise_parameter_sanitizer.permit(:account_update, keys: [:name, :phone_number, :email, :password, :password_confirmation, :baladia, ])
  end
